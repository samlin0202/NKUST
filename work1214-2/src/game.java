public class game {
    public static void main(String[] args) {
        ...
        System.out.println("----------------------------");
        Part2 Part2 = new Part2("Archer & Magician","附魔弓箭",5,"爆裂法仗",5,
                30,20,25,15,
                10,-5,25,5,5,30);
        Part2.getCurrentStatus();
        System.out.println("----------------------------");
        Part3 Part3 = new Part3("Magician & Berserker","爆裂法仗",5,"王者之劍",10,
                25,10,30,20,
                5,10,30,20,-10,25);
        Part3.getCurrentStatus();
    }
